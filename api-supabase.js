    ...
    async createTeacher(body) {
      ...
      if (authErr) {
        ...
        if (/already|registered|exists/i.test(msg)) {
          return {
            message: restored
              ? 'Teacher record saved. Login email already registered in Auth — confirm the user in Supabase Auth if needed.'
              : 'Teacher record saved. Login email already registered. Sign in again as admin.',
