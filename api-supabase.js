...
(function (global) {
  ...
  // sessionStorage: cleared when the browser tab is closed. Also cleared from the app
  // when the screen goes off / page is hidden (see index.html). Survives refresh only.
