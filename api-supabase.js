...
(function (global) {
  ...
  // localStorage: survives page refresh AND mobile app-switching (OS may kill the
  // WebView; sessionStorage is often wiped when that happens). Explicit Sign Out still clears it.
